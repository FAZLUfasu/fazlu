...
class PagesAdmin(admin.ModelAdmin):
    # Arrange tables under 'Pages' section
    model = InvestorProfile
    list_display = ('user', 'name', 'address', 'mobile_number', 'email')  # Example fields for display
    search_fields = ['name', 'email', 'mobile_number']

admin.site.register(InvestorProfile, PagesAdmin)
admin.site.register(MyProjects)
admin.site.register(Projectpage)
admin.site.register(AboutUs)
admin.site.register(ContactInfo)
...
# **UPDATION Section**
class UpdationAdmin(admin.ModelAdmin):
    # Arrange tables under 'Updation' section
    model = NewsUpdate
    list_display = ['title', 'date_published']
    search_fields = ['title', 'description']

admin.site.register(NewsUpdate, UpdationAdmin)
admin.site.register(Summary)
admin.site.register(Images)
admin.site.register(video)
...
class OthersAdmin(admin.ModelAdmin):
    # Arrange tables under 'Others' section
    model = BackgroundImage
    list_display = ['image']  # Example fields to display

admin.site.register(BackgroundImage, OthersAdmin)
admin.site.register(Notification)
admin.site.register(VideoNotification)
admin.site.register(Location)
...
# Inlines for InvestorProfile and Projectpage (for adding them in the admin of the related model)
class InvestorProfileInline(admin.StackedInline):
    model = InvestorProfile
    can_delete = False
    verbose_name_plural = 'Investor Profiles'
...
# Custom admin for project page to show associated projects
class CustomProjectpageAdmin(Projectpage):
    inlines = [MyProjectsInline]
